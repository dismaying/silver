export default function Hero() {
  return (
    <section className='relative text-center py-24 px-6 bg-gradient-to-br from-purple-700 via-purple-800 to-gray-900 text-gray-100 overflow-hidden'>
      ...
      <div className="absolute inset-0 z-0 bg-opacity-40 bg-[url('/silver.svg')] bg-cover bg-center pointer-events-none"></div>
      ...
      <div className='relative z-10 max-w-4xl mx-auto'>
        ...
        <p className='text-xl mb-8 text-gray-300 max-w-2xl mx-auto'>
          Start your journey to create fast, scalable, and beautiful
          applications. Powered by the expertise of{' '}
